...
public class ElectricFenceWindowFunction extends ProcessWindowFunction<ElectricFenceModel, ElectricFenceModel, String, TimeWindow> {
    ...
    /**
     * 初始化状态数据，状态保存上一个窗口内的状态信息，就是在电子栅栏内还是在电子栅栏外
     * 0 : 在电子栅栏内，  1 : 在电子栅栏外
     * Map<String,Byte>   String : VIN , Byte : 状态 0 或 1
     *
     * @param parameters
     * @throws Exception
     */
    ...
    @Override
    public void process(String vin, Context context, Iterable<ElectricFenceModel> elements, Collector<ElectricFenceModel> out) throws Exception {
        //1.创建返回对象
        ...
        System.out.println("窗口中的数据列表>>>"+electricFenceModelList);
        ...
        System.out.println("上一次窗口的state>>>"+lastStateValue);
